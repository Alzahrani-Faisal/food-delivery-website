...
<div class="aligned10 nav-background">
        <div class="container-fluid white-text">
            ...
            <form>
                <button id="red"class="order-now btn-gal">Order Now</button>
            </form>
        </div>
    </div>
...
<?php if (isset($_COOKIE["recently_bought"])) :
   ...
   <div class="menu" id="menu">
        ...
        <div class="row">
            ...
            <div class="col-lg-6" style="display:flex;align-items:center;">
                <div class="triangle-container" style="margin-bottom: 40px;">
                    ...
                    <p class="montserrat white-text" style="font-size: 16px;">If your are having a meeting, working late at night and need an extra push</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid" id="gallery">
        ...
        <p class="paragraph1">Try our most delicious food and usually take minutes to deliver</p>
        <div class="row">
            <?php for ($i = 0; $i < count($mealsArray); $i++): ?>
                <div href="detail.php" class="col-xs-12 col-md-4 col-lg-3 card">
                    <a href="detail.php?id=<?php echo $meal["id"] ?>">
                        <img alt="sandwich" src="projectImages/<?php echo $meal["image"] ?>">
                        <div class="container">
                            ...
                            <?php
                                ...
                                <p>Some description</p>
                                <div>
                                    <a href="cart.php?<?php echo sprintf("id=%s&back=%s", $mealsArray[$i]["id"], urlencode("../index.php#gallery")); ?>"
                                       class="yellow-button-a">
                                        <button class="inline-block yellow-button">
                                            add to cart
                                        </button>
   ...
   <div class="container-fluid align-responsive"  id="testimonials">
        <h2 class="padding-top">Clients Testimonials</h2>
        ...
        <div class="row">
            ...
            <div class="col-lg-6" style="position:sticky">
                <p class="p3 fixed-width1000">Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque
